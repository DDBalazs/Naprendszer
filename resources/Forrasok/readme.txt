...
Alakítsa ki az alábbi útvonalakat és hozzon hozzá létre egy-egy nézetet!
 ...
 ~/holdak/{id}  	egy hold adatlapja, paraméterben a hold ID-val
...
Bolygók view – ~/bolygok
 ...
 - A bolygók neve link, formázása fekete gomb és a bolygók ID-ját felhasználva (~/bolygo/{id}) egy-egy bolygó adatainak megjelenítésére szolgáljon. 
